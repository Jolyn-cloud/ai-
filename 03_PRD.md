...
|---|---|---|---|---|
| 演示外壳（总壳） | 已修复 | `05_UI设计/小程序总壳.html` | §0 / §3（承载） | 功能载体，非独立模块 |
| 顶栏（固定 appbar） | 已验收 | 总壳顶栏 | §3.2.3 | — |
| 登录 | 已验收 | 总壳登录 Sheet（唯一入口） | §3.2 | §五 个人中心 |
| 用户画像 | 已验收 | 总壳 × 学习页 × 我的页 | §3.3 | §五 个人中心 |
| 免费 VIP 权益 | 已验收 | 总壳权益引导层 | §3.4 | §五 个人中心 |
| **闪卡模块**（首页/单卡/列表/章节统计/背诵设置） | 已验收 | `闪卡首页.html` / `闪卡单卡.html` / `闪卡列表.html` / `闪卡章节统计.html` / `闪卡设置.html` + `闪卡题库.js` | **§4** | §3 题库页 · 闪卡小节 |
| 逻辑说明面板 | 重构中 | 总壳右侧面板 | — | — |
| 其余模块（AI 页/查询工具/内容/后台等） | 未校准 | — | — | [04_功能清单](04_功能清单.md) §二 各节 |

---

## 3. 登录 / 画像 / 免费 VIP 权益规则【已校准 · SSOT】
...
- 「每日 350 张」= 本节 §4.1.2 每日队列配额
- 「连续 N 天」= 连续完成当日队列的天数（完成定义：当日 350 张全部标记完毕）→ **完成判定口径待确认（F3）**

#### 4.6.1 章节区展示规则（2026-08-24 拍板）
...
| F2 | 完成结算页的数据维度（今日已记住/未记住/顽固卡数、用时、明日预告？） | 本文 §4.3 |
| F3 | 「连续 N 天」的完成判定：350 张全刷完才算，还是刷过即算 | 本文 §4.6 |
| F4 | 单卡模式右滑已记住的卡，是否允许「撤销」（误滑场景） | 本文 §4.3 |
| F5 | 首页总进度口径：分母是卡池总量，分子是已掌握 or 已掌握+已记住 | 本文 §4.6 |
